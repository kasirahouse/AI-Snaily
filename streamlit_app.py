...
if __name__ == '__main__':
    ...
    st.title('AI - Snaily')
    st.subheader('ARTIFICIAL INTELLIGENCE TO DETECT AND CLASSIFY BITHYNIA SP. SNAIL')
    st.subheader('Miss. Thannaree Jenwithee, Department of Parasitology, Faculty of Medicine, Khon Kaen University')
